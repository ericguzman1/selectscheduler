...
const GEMINI_API_KEY = "AIzaSyCr1StD14tSYPAPSbl9IO0IkPhhu9gfoVg"; // <- Replace with your Google AI Studio API Key
...
async function fetchGemini(prompt, isJson = false) {
    if (!GEMINI_API_KEY || GEMINI_API_KEY === "import React, { useState, useEffect, useRef } from 'react';
import { Calendar, Users, Briefcase, ChevronLeft, ChevronRight, Search, Zap, Trash2, BookOpen, ExternalLink, RefreshCw, XCircle } from 'lucide-react';
...
// --- UTILITY FETCH FUNCTION (FOR GEMINI ONLY) ---
async function fetchGemini(prompt, isJson = false) {
    if (!GEMINI_API_KEY || GEMINI_API_KEY === "AIzaSyCr1StD14tSYPAPSbl9IO0IkPhhu9gfoVg") {
